...
<meta name="description" content="Tools Untuk Menghitung Banyak Kata Dalam Tulisan">
</head>
<style>
...
<br>
<br>
<textarea name="isikata" id="isikata" style="height:300px; width:450px;">
Masukan katanya disini :)
</textarea><br>
<input type="submit" name="submit" value="Cek Kata"></input><br><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  echo "<center><h3>Hasil : $hasil kata.</h3></center>";
